        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Developed by <strong>BasavarajuVB</strong> - Fullstack Developer at Web3Today
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Developed by <a href="https://github.com/BasavarajuVB" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">BasavarajuVB</a> - Fullstack Developer at Web3Today
            </p>
          </div>
